<form method="POST" action="<?php echo site_url('laporan/lap_uangkeluar')?>" target="_blank">
<div class= "row">
...
<form method="POST" action="<?php echo site_url('laporan/lap_uangkeluarjenis')?>" target="_blank">
	<div class="box col-md-6">
		<div class="box-inner homepage-box">
			<div class="box-header well">
