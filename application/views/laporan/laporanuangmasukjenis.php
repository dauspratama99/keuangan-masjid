	...
	<body onload="window.print()"> <div id="laporan"> 
		...
		<table border="0" align="center" style="width:990px;margin-top:5px;border:none;marginbottom:0px;font-weight: bold;font-size: 16px">
			<tr>     
			 ...
			 </b> <tr>     <?php foreach($data->result_array() as $i) 
					{   ?>
				<td style="font-size: 14px;font-weight: italic;font-style:algerian;" align="center">Laporan Uang Masuk <?php echo $i['jeniskas']?></td>
			</tr>  <?php }?>
			</table>
