	...
	<body onload="window.print()"> <div id="laporan"> 
		...
		<table border="0" align="center" style="width:990px;margin-top:5px;border:none;marginbottom:0px;font-weight: bold;font-size: 16px">
			<tr>     
				...
				<td style="font-size: 14px;font-weight: italic;font-style:algerian;" align="center">Laporan Uang Keluar</td>
			</tr> 
			<tr> 
			</table>
			<table border="2" align="center" style="width:990px;margin-bottom:10px;font-size: 14px"> 
				<thead> 
					...
					<tr style="background-color: #d0cbcb; vertical-align: middle;height: 30px">         
						...
						<th style="width: 130px">Kas Keluar</th>         
						<th style="width: 130px">Tanggal Keluar</th> 
						 
						<th style="width: 120px">Uraian</th>  <th style="width: 120px">Jumlah</th>       
				...
				<tbody> 
					...
					{       
						...
						<tr>         
							...
							<td><?php echo $i['tglkeluar'] ?></td>        
							  
							<td><?php echo $i['uraian'] ?></td>    
							<td align="right"><?php echo 'Rp '.number_format($i['jumlah']);?></td>
						</tr> <?php }?>     
						<tr>         
							<td colspan="4" style="font-weight: bold;text-align: center">Total</td>         <td align="right"><?php echo 'Rp '.number_format($total);?></td>     
						</tr> 
					</tbody> 
				</table> 
