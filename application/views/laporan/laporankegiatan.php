...
<head>     
	...
	<body onload="window.print()"> <div id="laporan"> 
		...
		<table border="0" align="center" style="width:990px;margin-top:5px;border:none;marginbottom:0px;font-weight: bold;font-size: 16px">
			...
			<tr>     
				<td style="font-size: 14px;font-weight: italic;font-style:algerian;" align="center">Laporan Kegiatan</td>
			</tr>  
		</table>
		...
		<tbody> 
			...
			{       
				...
				<tr>         
					...
					<td><?php echo $i['kd_kegiatan'] ?></td>         
					<td><?php echo $i['nama'] ?></td>
                    <td><?php echo $i['ketua'] ?></td>
                    <td><?php echo $i['tglkegiatan'] ?></td>        
