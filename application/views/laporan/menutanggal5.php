<form method="POST" action="<?php echo site_url('laporan/lap_keuangan')?>" target="_blank">
<div class= "row">
					...
					<tr>   
						<td>            
							<div class="modal-footer">           
								 <button type="submit" class="btn btn-primary" data-dismiss="modal"><i class="glyphicon glyphiconprint"></i> Cetak</button>   
								<button type="button" class="btn btn-danger" href="<?php echo site_url('index.php/beranda/')?>" data-dismiss="modal"><i class="fa fatimes"></i> Tutup</button>         
							</div>       
						</td> 
					</tr>  
				</table>
...
<form method="POST" action="<?php echo site_url('laporan/lap_keuanganjenis')?>" target="_blank">
	<div class="box col-md-6">
		<div class="box-inner homepage-box">
			<div class="box-header well">
