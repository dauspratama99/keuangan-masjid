<div class="row">
	<div class="box col-md-12">
	    <a href="<?php echo site_url('kegiatan/tambah') ?>" class="btn btn-primary ">
		                ...
		                <table class="table table-striped table-bordered bootstrap-datatable datatable responsive dataTable" id="dataTables-example" aria-describedby="DataTables_Table_0_info">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="<?php echo site_url('kegiatan/edit/' . $baris['kd_kegiatan']) ?>">
                                        <i class="glyphicon glyphicon-edit icon-white"></i>
                                        Edit
                                        </a>
                                        <button type="button" class="btn btn-danger" onclick="return hapus('<?php echo $baris['kd_kegiatan'] ?>')">
                                            <i class="glyphicon glyphicon-trash icon-white"></i>
                                            Hapus
                                        </button>
                                        <script>
                                            function hapus(kode) {
                                                pesan = confirm('Yakin data kegiatan ini di hapus');
                                                if (pesan) 
                                                {
                                                    location.href = ('<?php echo site_url('kegiatan/hapus/') ?>' + kode);
                                                } else
                                                    return false;
                                            }
                                        </script>
