...
<div class="box-content">         
    <?php echo form_open('kegiatan/update', array('class' => 'form-horizontal')) ?>
        <div class="box-body">
            <div class="box-inner">
                ...
                <div class="box-content">
                    <form role="form">
				        <div class="form-group"><font color="#000000">
                            ...
                            <div class="col-sm-4">
                                <input type="text" name="kd_kegiatan" class="form-control" value="<?php echo $kd_kegiatan;?>" readonly="readonly">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" name="ketua" class="form-control" value="<?php echo $ketua;?>">
                                <span style="font-weight: bold; color: red;"><?php echo form_error('ketua') ?></span>
                            </div>
                        </div>                
				        <div class="form-group">
