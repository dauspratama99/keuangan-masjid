<h3 class="box-title">
<a href="<?php echo site_url('penceramah') ?>" class="btn btn-primary btn-lg"><i class="glyphicon glyphicon-chevron-left glyphicon-white"></i> Kembali </a>   
</h3><?php echo $this->session->flashdata('pesan');?>
<div class="box col-md-12">
		<div class="box-content">
   
          <?php echo form_open('penceramah/simpan', array('class' => 'form-horizontal')) ?>
            <div class="box-body">
            ...
            <div class="box-content">
                <form role="form">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="kd_penceramah" value="<?php echo $kd_penceramah?>" class="form-control" readonly>
