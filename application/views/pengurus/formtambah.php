...
<div class="box col-md-12">
		<div class="box-content">
          ...
          <?php echo form_open('pengurus/simpan', array('class' => 'form-horizontal')) ?>
            <div class="box-body">
            ...
            <div class="box-content">
                <form role="form">
                    ...
                    <label class="col-sm-2 control-label">Kode Pengurus</label>
                    <div class="col-sm-6">
                        <input type="text" name="kd_pengurus" value="<?php echo $kd_pengurus ?>" class="form-control" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        ...
                        <span style="font-weight: bold; color: red;"><?php echo form_error('nohp') ?></span></font>
                    </div>
                </div>
